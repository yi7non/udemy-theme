...
function ju_enqeueu() {
  wp_register_style('ju_google-font', '//fonts.googleapis.com/css?family=Lato:300,400,400italic,600,700|Raleway:300,400,500,600,700|Crete+Round:400italic');
  ...
  wp_enqueue_style('ju_google-font');
